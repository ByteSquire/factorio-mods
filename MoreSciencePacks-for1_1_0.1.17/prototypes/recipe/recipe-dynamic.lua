...
if mods["omnilib"] and settings.startup["moresciencepack-Omni-Ignored"].value == false then 
	...
	local refTechPreq = {["1"] = nil, ["2"] = "optics", ["3"] = "turrets", ["4"] = "electronics", ["5"] = "automation-2", ["6"] = "advanced-material-processing",
			["7"] = "circuit-network", ["8"] = "oil-processing", ["9"] = "electric-energy-accumulators", ["10"] = "sulfur-processing", ["11"] = "rail-signals", ["12"] = "construction-robotics",
			["13"] ="flamethrower", ["14"] ="tanks", ["15"] = "laser-turrets", ["16"] = "combat-robotics", ["17"] = "electric-energy-distribution-2", ["18"] = "productivity-module-2",
			["19"] = "nuclear-power", ["20"] = "automation-3", ["21"] = "energy-shield-mk2-equipment", ["22"] = "logistics-3", ["23"] = "effect-transmission", ["24"] = "logistic-system",
			["25"] = "fusion-reactor-equipment", ["26"] = "advanced-oil-processing", ["27"] = "explosive-rocketry", ["28"] = "artillery", ["29"] = "atomic-bomb", ["30"] = "rocket-silo"}
	...
	for i=1,30 do 
		if settings.startup["MSP-pack".. i .. "-result"].value > 0 then --if pack is enabled, generate recipe		
			...
			if generateItem==true then 
				ingredients = omni.marathon.standardise(data.raw.recipe[recipeName]).normal.ingredients
