...
if legacyMode then --if either the legacyMode config is set to true or if omnilib is not detected, we must add unlocks for recipes in recipe.lua to their proper techs. 
	...
	morescience.tech.add_recipe_unlock("tank", "more-science-pack-14") 
	morescience.tech.add_recipe_unlock("laser-turret", "more-science-pack-15") 
	morescience.tech.add_recipe_unlock("defender", "more-science-pack-16") 
